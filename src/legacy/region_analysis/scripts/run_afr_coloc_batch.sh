#!/bin/bash
#BSUB -J afr_coloc[1-150]
#BSUB -o logs/afr_coloc_%I.out
#BSUB -e logs/afr_coloc_%I.err
#BSUB -n 1
...
PAIR_ID=$(sed -n "${LSB_JOBINDEX}p" /gpfs_common/share01/clintonlab/ckclinto/admix_map/results/multitrait/afr_pairs.txt)
